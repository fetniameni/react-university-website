    ...
    <div className='home-page'>
        <header className='h-100 min-vh-100 d-flex align-items-center text-light'>
            <div className='container d-flex flex-column align-items-center'>
                <h2>Welcome to </h2>
                <h1 className='text-center fw-semibold'> Pixel Institute</h1>
                <p>The Pixel Institute is a professional diploma training establishment in Tunisia (BTS, BTP, CAP).</p>
